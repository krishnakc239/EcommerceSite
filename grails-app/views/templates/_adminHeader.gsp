    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li>
                    <g:link controller="index" action="index"><span class="glyphicon glyphicon-home"> Home</span></g:link>
                </li>
                <li>
                ...
                <li>
                    <g:link controller="user" action="home"><span class="glyphicon glyphicon-plane"> Delevery</span></g:link>
                </li>
                <li>
                    <g:link controller="index" action="index"><span class="glyphicon glyphicon-phone-alt"> Contact</span></g:link>
                </li>
            </ul>
