        ...
        <div class="container">
            ...
            <div id="footer-wrapper">
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6 col-md-2">
                        <div  class="">
                            <h4 class="widgettitle">Our Socila Media :</h4>
                            <ul class="list-unstyled">
                                %{--<li><a href="#"><i class="fa fa-home fa-fw"></i> Home</a></li>--}%
                                <li><a href="#"><i class="fa fa-link"></i>Facebook</a></li>
                                <li><a href="#"><i class="fa fa-envelope fa-fw"></i>Twitter</a></li>
                            </ul>
                        </div>
                    </div> <!-- end widget1 -->
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div id="search-3" class="widget widgetFooter widget_search"><h4 class="widgettitle">Search your desire :</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4 attribution">
                    Developed by  <a target="_blank" href="#">Krishna K.C</a> .
                </div>
            </div> <!-- end .row -->
        </div>
    </div>
